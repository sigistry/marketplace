...
- Submitting plugins that intentionally mislead users about what they do, or
  that attempt to bypass or game the verification process
...
stay private, by contacting the maintainer directly via GitHub
([@williankeller](https://github.com/williankeller)).
